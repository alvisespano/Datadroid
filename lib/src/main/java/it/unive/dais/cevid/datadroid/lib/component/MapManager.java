...
public abstract class MapManager {
    ...
    @NonNull
    public <I extends MapItem> Collection<Marker> putMarkersFromCsv(Reader rd, boolean hasHeader, String sep, Function<CsvParser.Row, I> createMapItem, float hue) throws ExecutionException, InterruptedException {
        return putMarkersFromCsv(new CsvParser(rd, hasHeader, sep, null), createMapItem, hue);
    }

    @NonNull
    @SuppressLint("StaticFieldLeak")
    public <I extends MapItem> Collection<Marker> putMarkersFromCsv(URL url, boolean hasHeader, String sep, Function<CsvParser.Row, I> createMapItem, float hue) throws ExecutionException, InterruptedException {
